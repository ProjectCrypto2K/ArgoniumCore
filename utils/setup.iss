...
#define MyAppName "Argoniumcore"
;#define MyAppVersion "0.2.0.31"
#define MyAppPublisher "Argoniumcore Team"
#define MyAppURL "http://argoniumcore.com"
#define MyAppExeName "qt-argoniumc.exe"
...
[Registry]
Root: HKCR; Subkey: ".bbr"; ValueType: string; ValueName: ""; ValueData: "ArgoniumcoreWalletDataFile"; Flags: uninsdeletevalue
Root: HKCR; Subkey: ".bbr.keys"; ValueType: string; ValueName: ""; ValueData: "ArgoniumcoreWalletDataKyesFile"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "ArgoniumcoreWalletDataFile"; ValueType: string; ValueName: ""; ValueData: "Argoniumcore Wallet's Data File"; Flags: uninsdeletekey
Root: HKCR; Subkey: "ArgoniumcoreWalletDataKyesFile"; ValueType: string; ValueName: ""; ValueData: "Argoniumcore Wallet's Keys File"; Flags: uninsdeletekey

Root: HKCR; Subkey: "ArgoniumcoreWalletDataFile\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\qt-argoniumc.exe,0"
Root: HKCR; Subkey: "ArgoniumcoreWalletDataKyesFile\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\qt-argoniumc.exe,0"


[Files]
Source: "{#BinariesPath}\argoniumcd.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "{#BinariesPath}\qt-argoniumc.exe"; DestDir: "{app}"; Flags: ignoreversion
