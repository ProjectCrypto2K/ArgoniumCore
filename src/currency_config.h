...
#define CURRENCY_PUBLIC_ADDRESS_BASE58_PREFIX         0x2cca // addresses start with "1", edit:
...
#define TOTAL_MONEY_SUPPLY                            ((uint64_t)(-1))//edit: Total amount of coins to be emitted. Most of ArgoniumCore-based coins use (uint64_t)(-1) (equals to 18446744073709551616). You can define number explicitly (for example UINT64_C(858986905600000000)).
#define DONATIONS_SUPPLY                              (TOTAL_MONEY_SUPPLY/100) //edit: TOTAL MONEY SUPPLY / 100 = DONATIONS SUPPLY
#define EMISSION_SUPPLY                               (TOTAL_MONEY_SUPPLY - DONATIONS_SUPPLY) //edit: TOTAL MONEY SUPPLY - DONATIONS SUPPLY = EMISSION SUPPLY
...
#define DIFFICULTY_TARGET                               120 // seconds, edit: Difficulty target is an ideal time period between blocks. In case an average time between blocks becomes less than difficulty target, difficulty increases. Difficulty target is measured in seconds.
...
#ifndef TESTNET
#define P2P_DEFAULT_PORT                                836 //edit: P2P port is used by daemons to communicate with each other through P2P protocol.
#define RPC_DEFAULT_PORT                                846 //edit: RPC port is used by wallet and other software to communicate with the daemon.
#else
#define P2P_DEFAULT_PORT                                48654 //edit: P2P port is used by daemons to communicate with each other through P2P protocol.
#define RPC_DEFAULT_PORT                                48854 //edit: RPC port is used by wallet and other software to communicate with the daemon.
#endif
...
/* This money will go to growth of the project */
  #define CURRENCY_DONATIONS_ADDRESS                     ""
  #define CURRENCY_DONATIONS_ADDRESS_TRACKING_KEY        ""
/* This money will go to the founder of ArgoniumCore technology, 10% of donations */
  #define CURRENCY_ROYALTY_ADDRESS                       ""
  #define CURRENCY_ROYALTY_ADDRESS_TRACKING_KEY          ""
...
#define CURRENCY_NAME_BASE                              "ArgoniumCore" //edit: Name must be specified twice
#define CURRENCY_NAME_SHORT_BASE                        "argoniumcore" //edit: Here it is obligatory with a small letter
#ifndef TESTNET
